namespace NJG.Graph
{
    ...
    public class GraphReactionsEditor : MultiSubEditor<MBVariableEditor, MBVariable>
    {
        ...
        public void CheckInvoker()
        {
            ...
            spReferences.AddToObjectArray(variable);
        ...
        public void SyncBehaviorGraph(StateMachine sm = null)
        {
            ...
            // if (subEditors == null)
            // {
            //     Debug.Log("[subEditors] Cannot update GraphReactions state machine.");
            //     return;
            // }
            // if (subEditors.Length == 0)
            // {
            //     Debug.Log("[subEditors empty] Cannot update GraphReactions state machine.");
            //     return;
            // }
            ...
            for (int i = 0; i < addListCount; ++i)
            {
                ...
                AddToObjectArray<MBVariable>(spReferences, variable);
