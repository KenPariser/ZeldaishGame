    ...
    public class BlackboardWindow
    {
        ...
        public static void UpdateVariables()
        {
                ...
                GraphEditor.Reactions.references != null)
            {
                ...
                GraphEditor.Instance.ReactionsEditor.UpdateSubEditors(GraphEditor.Reactions.references);
                // GraphEditor.Instance.ReactionsEditor.CheckInvoker();
                GraphEditor.Instance.ReactionsEditor.SyncBehaviorGraph((StateMachine)GraphEditor.Instance.StateMachineEditor.target);
                GraphEditor.Instance.ReactionsEditor.UpdateLocalVariables();
                GraphEditor.Instance.ReactionsEditor.Repaint();
            }
        }
    }
}